<template>
  <div class="min-h-screen relative dark:bg-zinc-800 z-30">
    <!-- <div class="min-h-screen bg-neutral-50 dark:bg-zinc-800 relative z-10"> -->
    <div class="max-w-5xl mx-auto flex flex-col min-h-screen justify-between">
      <div class="space-y-12">
        <header class="flex flex-col pt-12">

          <div class="flex items-center justify-between">

            <div class="flex flex-wrap space-y-4">
              <a
                class="text-3xl font-sans font-semibold dark:text-zinc-100 hover:text-orange-700 dark:hover:text-orange-600"
                href="/"
              >{{ $static.metadata.siteName }}</a>

              <nav class="w-full flex items-center space-x-6">
                <g-link
                  class="font-mono text-zinc-900 dark:text-zinc-100 hover:text-orange-700 dark:hover:text-orange-600"
                  to="/about/"
                >
                  about
                </g-link>
            ...
            >
              ...
              <path
                stroke-width="3"
                d="M1.5 21.488h55.537v55.537H1.5z"
              />
              <path
                d="M42.49 43.366L58.538 14.31l16.046 29.056H42.49z"
                stroke-width="3"
              />
            </svg>
          </div>
      ...
      <footer
        v-if="$route.path != '/'"
        class="flex items-center justify-between text-sm relative bottom-0 w-full border-t border-dashed border-zinc-900 dark:border-zinc-100 mt-12 py-6"
      >
        <span class="text-zinc-900 dark:text-zinc-100">Copyright © Juho Pekkala {{ new Date().getFullYear() }}. All rights reserved. <span class="font-mono tracking-tighter">(⌐■_■)</span> </span>
        <!--span class="text-zinc-900 dark:text-zinc-100">Powered by <a
            href="//netlify.com"
            target="_blank"
        ...
        <div class="flex items-center space-x-4 text-zinc-900 dark:text-zinc-100">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 512"
            class="w-5 h-5 shrink-0 text-zinc-900 dark:text-zinc-100"
            stroke="currentColor"
          >
