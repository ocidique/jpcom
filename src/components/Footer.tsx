  ...
  return (
    <footer className="flex flex-col lg:flex-row max-w-5xl mx-auto items-center text-sm relative bottom-0 w-full border-t border-zinc-300 dark:border-zinc-700 mt-10 px-2 sm:px-6 xl:px-0 py-6 lg:py-10 space-y-6 lg:space-y-0">
      ...
      <div className="w-full lg:w-1/2 flex flex-wrap items-center justify-center lg:justify-end space-x-4 text-zinc-700 dark:text-zinc-300">
        ...
        {/* GoodReads ! Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc. */}
        <a href="https://www.goodreads.com/user/show/101525953-juho" target="_blank" className="hover:text-orange-500">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
            className="w-5 h-5 shrink-0 fill-zinc-700 dark:fill-zinc-300 hover:fill-orange-500 hover:cursor-pointer"
          >
        ...
        <a href="https://www.imdb.com/user/ur14952127/" target="_blank" className="hover:text-orange-500">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            className="w-5 h-5 shrink-0 fill-zinc-700 fill:text-zinc-300 hover:fill-orange-500 dark:hover-fill-orange-500 hover:cursor-pointer"
        ...
        {/* <div className="font-mono text-xl text-zinc-700 dark:text-zinc-300" aria-hidden="true">
          /
        </div> */}
